<template>
	<div class="header">
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px"
			 height="20px" viewBox="0 0 14.44 23.25" style="enable-background:new 0 0 14.44 23.25;" xml:space="preserve">
		...
		<h1 :class="{underline: !hideUnderline}">{{ text }}</h1>
	</div>
</template>
<script lang="ts">
...
<style scoped>
	.header {
		...
		.underline {
			border-bottom: 2px solid rgb(229, 157, 126);
		}
